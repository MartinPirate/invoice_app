    ...
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="invoice-work flex flex-column">
        ...
        <div class="payment flex">
          ...
          <div class="input flex flex-column">
            <label for="paymentDueDate">Payments Due Date </label>
            <input disabled type="text" id="paymentDueDate" v-model="paymentDueDate">
          </div>
        </div>

        <div class="input flex flex-column">
          <label for="paymentTerms">Payments Terms</label>
        ...
        <div class="save flex">
          ...
          <div class="right flex">
            ...
            <button v-if="editInvoice" type="submit" @click="updateInvoice" class="purple">Update</button>
...
.invoice-wrap {
  ...
  .invoice-content {
    ...
    color: #ffffff;
    box-shadow: 10px 4px 6px -1 rgba(0, 0, 0, 0.2) 0 2px 4px -1px rgba(0, 0, 0, 0.06);
